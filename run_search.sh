...
python3 -m main -c mnist_pg
python3 -m main -c cifar10_pg
python3 -m main -c spotify_pg
...
#python3 -m main -c spotify_search_pg_mmd
#python3 -m main -c spotify_search_pg_ent
#python3 -m main -c spotify_search_pg_l1
#python3 -m main -c spotify_search_pg_l2
